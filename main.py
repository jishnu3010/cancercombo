...
def main():
    ...
    parser.add_argument(
        ...
        help="Execution engine: native, lightning, or auto (default: native — Lightning's TQDMProgressBar callback has caused hangs on this hardware; see commit b83196e)"
    )
